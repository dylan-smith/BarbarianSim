...
public enum Skill
{
    ...
    WarriorsRupture,
    FightersRupture,
    Hamstring, // Your Bleeding effects Slow Healthy enemies by 10%
    CutToTheBone,
    SteelGrasp,
    EnhancedSteelGrasp,
    WarriorsSteelGrasp,
    ...
    SupremeWrathOfTheBerserker, // While Wrath of the Berserker is active, every 50 Fury you spend increases Berserk's damage bonus by 25%[x]
    Wallop,
