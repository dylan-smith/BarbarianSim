...
public class WrathOfTheBerserker
{
    ...
    public WrathOfTheBerserker(WrathOfTheBerserkerEventFactory wrathOfTheBerserkerEventFactory,
                               AuraAppliedEventFactory auraAppliedEventFactory)
    {
        _wrathOfTheBerserkerEventFactory = wrathOfTheBerserkerEventFactory;
        _auraAppliedEventFactory = auraAppliedEventFactory;
    }

    private readonly WrathOfTheBerserkerEventFactory _wrathOfTheBerserkerEventFactory;
    ...
    public void Use(SimulationState state) => state.Events.Add(_wrathOfTheBerserkerEventFactory.Create(state.CurrentTime));
