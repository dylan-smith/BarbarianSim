...
public class WarbringerTests
{
    ...
    {
        var furySpentEvent = new FurySpentEvent(0, 77, SkillType.None) { FurySpent = 77 };
    ...
    public void Sums_All_FurySpentEvents()
    {
        ...
        _state.ProcessedEvents.Add(new FurySpentEvent(127, 57, SkillType.None) { FurySpent = 57 });
    ...
    {
        _state.ProcessedEvents.Add(new WarbringerProcEvent(123));
        _state.ProcessedEvents.Add(new FurySpentEvent(123, 46, SkillType.None) { FurySpent = 46 });
        _state.ProcessedEvents.Add(new FurySpentEvent(127, 57, SkillType.None) { FurySpent = 57 });
    ...
    {
        var furySpentEvent = new FurySpentEvent(0, 74, SkillType.None) { FurySpent = 74 };
        _state.ProcessedEvents.Add(furySpentEvent);
    ...
    {
        _state.ProcessedEvents.Add(new FurySpentEvent(123, 76, SkillType.None) { FurySpent = 76 });
        _state.ProcessedEvents.Add(new WarbringerProcEvent(123));
        _state.ProcessedEvents.Add(new FurySpentEvent(124, 46, SkillType.None) { FurySpent = 46 });
