...
public class MarshalTests
{
    ...
    {
        var warCryCooldownAuraExpiredEvent = new AuraExpiredEvent(123, Aura.WarCryCooldown);
        _state.Events.Add(warCryCooldownAuraExpiredEvent);

        var challengingShoutCooldownAuraAppliedEvent = new AuraAppliedEvent(112, 20, Aura.ChallengingShoutCooldown);
    ...
    public void Reduces_Multiple_Shout_Cooldowns()
    {
        ...
        var rallyingCryCooldownAuraExpiredEvent = new AuraExpiredEvent(125, Aura.RallyingCryCooldown);
    ...
    public void Does_Not_Reduce_Cooldown_Of_Triggering_Shout()
    {
        ...
        var challengingShoutCooldownAuraExpiredEvent = new AuraExpiredEvent(132, Aura.ChallengingShoutCooldown);
    ...
    {
        var warCryCooldownAuraExpiredEvent = new AuraExpiredEvent(112.5, Aura.WarCryCooldown);
        _state.Events.Add(warCryCooldownAuraExpiredEvent);
