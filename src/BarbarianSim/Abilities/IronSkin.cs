...
public class IronSkin
{
    ...
    public IronSkin(IronSkinEventFactory ironSkinEventFactory) => _ironSkinEventFactory = ironSkinEventFactory;

    private readonly IronSkinEventFactory _ironSkinEventFactory;
    ...
    public void Use(SimulationState state) => state.Events.Add(_ironSkinEventFactory.Create(state.CurrentTime));
